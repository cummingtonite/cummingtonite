...
void StakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("cummingtonite-stakeminer");
...
void static CummingtoniteMiner(CWallet *pwallet)
{
    printf("CummingtoniteMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("cummingtonite-miner");
    ...
    {
        printf("CummingtoniteMiner terminated\n");
        throw;
    }
}

void GenerateCummingtonites(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CummingtoniteMiner, pwallet));
}
